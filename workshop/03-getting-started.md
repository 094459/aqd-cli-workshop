...
You can check out the [kiro docs](https://kiro.dev/docs/cli/chat/model-selection/) to see the available models to you, as well as get some additional info about how to choose a model.
...
* [Kiro.dev](https://kiro.dev/docs/cli/)

* [Kiro Steering documents](https://kiro.dev/docs/cli/steering/)

* [Kiro Context Management](https://kiro.dev/docs/cli/chat/context/)

* [Kiro custom agent examples](https://kiro.dev/docs/cli/custom-agents/examples/)
